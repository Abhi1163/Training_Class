...
public class SearchFriendViewResponseContentList {
    ...
    public Integer getBusiness_open() {
        return business_open;
    }

    public void setBusiness_open(Integer business_open) {
    ...
    public Integer getSocial_id() {
        return social_id;
    }

    public void setSocial_id(Integer social_id) {
    ...
    public Object isAlready_friend() {
        return already_friend;
    }

    public void setAlready_friend(Object already_friend) {
